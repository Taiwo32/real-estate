...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "bd6739f3-2d7a-4cc6-9ea3-4e3dfd2e0237");
    ...
    return (
        <motion.div
            ...
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
                ...
                <button className='bg-orange-600 text-white py-2 px-12 mb-10'>{result ? result : "Send Message"}</button>
            </form>
        </motion.div>
    )
}
